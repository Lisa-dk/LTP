...
# Predict the values of reddit comments using our own trained roberta model
# See https://huggingface.co/nikolai40/human-values-roberta-aug
...
for i, d in tqdm(enumerate(debaters)):
    ...
    for c in tqdm(d["comments"]):
        ...
        # tokens = tokens.to('cuda') # uncomment if using gpu
